---
title: "brainstorming References Index"
description: "Index of all reference files for the brainstorming skill -- structured ideation and critique techniques for design exploration, plus a diagnostic for design debates that loop without converging."
domain: skills
subdomain: brainstorming
tags: [skills, brainstorming, references, index]
related:
  - "../SKILL.md"
---

# brainstorming References Index

Reference files consulted during design exploration -- techniques for generating and critiquing ideas, and a diagnostic for when a design debate stalls.
...
- [SKILL.md](../SKILL.md) -- enforcement gate for the brainstorming skill
