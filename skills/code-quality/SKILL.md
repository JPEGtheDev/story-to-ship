...
- Renaming or moving a short/common identifier via sed/awk/find-replace -- **STOP. Rename or move must preserve semantics: grep, compare hits to rename sites; substrings in longer names, strings, or comments change meaning. Use scope-aware rename.**
