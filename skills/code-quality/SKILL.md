...
- Renaming a short/common identifier via sed/awk/find-replace -- **STOP. A rename must preserve semantics: grep it and compare hits to rename sites; substrings in longer names, strings, or comments silently change meaning. Use scope-aware (IDE) rename.**
