...
| File | Covers |
|------|--------|
| `code-smells.md` | 7 universal smells -- six from Fowler's _Refactoring_ (Long Method, Duplicated Code, Long Parameter List, Speculative Generality, Divergent Change, Shotgun Surgery), plus Implicit State Through an Unstructured Jump |
