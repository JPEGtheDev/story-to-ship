...
3. **DISPATCHING agent:** Dispatch a `postmortem-reviewer` subagent as external reviewer. For self-assessment authorship rules, follow the Independence Gate in `references/POSTMORTEM_STRUCTURE.md`.
