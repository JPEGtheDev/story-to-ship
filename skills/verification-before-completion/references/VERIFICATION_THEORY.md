...
The discipline this calls for extends past garbage collection to any performance claim: before accepting that something is "too slow" or "cheap enough," measure it on the actual workload in question, using a controlled comparison similar to the allocator-versus-collector swap above, rather than leaning on a technique's reputation.
